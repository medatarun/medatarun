...
class ConfigResource(private val runtime: AppRuntime) {
    @Suppress("unused")
    @ResourceCommandDoc(title = "Inspect config", description = "Returns a human-readable list of the configuration, including extension contributions and contribution points, what provides what to whom.")
    fun inspect(): String {
