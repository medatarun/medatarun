...
| ---------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `@fluentui/react-components`       | Fluent UI design system: component library used to build React screens. Peer dep required by `@seij/common-ui`, `@seij/common-ui-richtext`.                                                     |
| `@fluentui/react-icons`            | Fluent UI icons. Peer dep required by `@seij/common-ui-icons`, `@seij/common-ui-richtext`. Also used directly for icons not covered by `@seij/common-ui-icons`.                                 |
| `i18next`                          | Peer dep required by `@seij/common-ui`. Internationalisation engine used by the `@seij` UI shell.                                                                                               |
| `i18next-browser-languagedetector` | Peer dep required by `@seij/common-ui`. Detects user language from browser settings.                                                                                                            |
| `i18next-icu`                      | Peer dep required by `@seij/common-ui`. Adds ICU message format support to i18next.                                                                                                             |
| `lexical`                          | Peer dep required by `@seij/common-ui-richtext`. Core Lexical editor engine.                                                                                                                    |
| `@lexical/react`                   | Peer dep required by `@seij/common-ui-richtext`. React bindings for the Lexical editor.                                                                                                         |
| `oidc-client-ts`                   | Peer dep required by `@seij/common-ui-auth`. Low-level OIDC/OAuth2 client.                                                                                                                      |
| `react-oidc-context`               | Peer dep required by `@seij/common-ui-auth`. React context wrapping `oidc-client-ts` for authentication flows.                                                                                  |
...
| `@seij/common-ui-richtext`         | `@seij`: shared Rich text editor based on Lexical.                                                                                                                                              |
...
| `@vitejs/plugin-react`        | Vite React plugin: enables React Fast Refresh during development and configures React JSX handling. With Vite 8+, React Refresh is handled through Vite/Oxc instead of Babel by default. |
