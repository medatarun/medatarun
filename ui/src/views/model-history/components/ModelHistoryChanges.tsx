...
function RelationshipAttributeNameOf({relationshipId, attributeId}: { relationshipId: string, attributeId: string }) {
  const model = useModelContext()
  return model.findRelationshipAttributeDto(relationshipId, attributeId)?.name
    ?? model.findRelationshipAttributeDto(relationshipId, attributeId)?.key
    ?? "[unknown]"
}

function RelationshipRoleNameOf({relationshipId, relationshipRoleId}: {
  relationshipId: string,
  relationshipRoleId: string
}) {
  const model = useModelContext()
  const role = model.findRelationshipDto(relationshipId)?.roles.find((it) => it.id === relationshipRoleId)
...
const eventMap: Record<string, EventDisplayMode> = {
  ...
  "entity_created": {
    label: (event: ModelChangeEventDto) =>
      renderTranslatedSlots("created entity {entity}", {
        entity: <SlotTextValue value={event.payload.name ?? event.payload.key}/>
      }),
    payload: (event: ModelChangeEventDto) =>
      renderTranslatedSlots("identifier attribute {attribute} with type {type} and mode {optional}", {
        attribute: <SlotTextValue value={event.payload.identityAttributeName ?? event.payload.identityAttributeKey}/>,
        type: <TypeNameOf typeId={event.payload.identityAttributeTypeId as string}/>,
        optional: <OptionalityValue optional={Boolean(event.payload.identityAttributeOptional)}/>
      })
  },
  "entity_key_updated": {
    label: (event: ModelChangeEventDto) =>
  ...
  "entity_identifier_attribute_updated": {
    label: (event: ModelChangeEventDto) =>
      renderTranslatedSlots("changed identifier attribute of entity {entity} to {attribute}", {
        entity: <EntityNameOf entityId={event.payload.entityId as string}/>,
        attribute: <EntityAttributeNameOf
  ...
  "entity_documentation_home_updated": {
    label: (event: ModelChangeEventDto) =>
      renderTranslatedSlots("changed documentation home of entity {entity} to {documentationHome}", {
        entity: <EntityNameOf entityId={event.payload.entityId as string}/>,
        documentationHome: <SlotLinkValue href={String(event.payload.documentationHome)}/>
      }),
    payload: (event: ModelChangeEventDto) => null
  },
  "entity_tag_added": {
  ...
  "entity_attribute_created": {
    label: (event: ModelChangeEventDto) =>
      renderTranslatedSlots("created attribute {attribute} on entity {entity}", {
        attribute: <SlotTextValue value={event.payload.name ?? event.payload.key}/>,
        entity: <EntityNameOf entityId={event.payload.entityId as string}/>
      }),
    payload: (event: ModelChangeEventDto) =>
      renderTranslatedSlots("type {type}, mode {optional}", {
        type: <TypeNameOf typeId={event.payload.typeId as string}/>,
        optional: <OptionalityValue optional={Boolean(event.payload.optional)}/>
      })
  },
  "entity_attribute_deleted": {
    label: (event: ModelChangeEventDto) =>
      renderTranslatedSlots("deleted attribute {attribute} from entity {entity}", {
        attribute: <EntityAttributeNameOf
          entityId={event.payload.entityId as string}
  ...
  "entity_attribute_key_updated": {
    label: (event: ModelChangeEventDto) =>
      renderTranslatedSlots("changed key of attribute {attribute} on entity {entity} to {key}", {
        attribute: <EntityAttributeNameOf
          entityId={event.payload.entityId as string}
          attributeId={event.payload.attributeId as string}
        />,
  ...
  "entity_attribute_name_updated": {
    label: (event: ModelChangeEventDto) =>
      renderTranslatedSlots("changed name of attribute {attribute} on entity {entity} to {name}", {
        attribute: <EntityAttributeNameOf
          entityId={event.payload.entityId as string}
          attributeId={event.payload.attributeId as string}
        />,
  ...
  "entity_attribute_description_updated": {
    label: (event: ModelChangeEventDto) =>
      renderTranslatedSlots("changed description of attribute {attribute} on entity {entity}", {
        attribute: <EntityAttributeNameOf
          entityId={event.payload.entityId as string}
          attributeId={event.payload.attributeId as string}
        />,
  ...
  "entity_attribute_type_updated": {
    label: (event: ModelChangeEventDto) =>
      renderTranslatedSlots("changed type of attribute {attribute} on entity {entity} to {type}", {
        attribute: <EntityAttributeNameOf
          entityId={event.payload.entityId as string}
          attributeId={event.payload.attributeId as string}
        />,
  ...
  "entity_attribute_optional_updated": {
    label: (event: ModelChangeEventDto) =>
      renderTranslatedSlots("changed mode of attribute {attribute} on entity {entity} to {optional}", {
        attribute: <EntityAttributeNameOf
          entityId={event.payload.entityId as string}
          attributeId={event.payload.attributeId as string}
        />,
  ...
  "entity_attribute_tag_added": {
    label: (event: ModelChangeEventDto) =>
      renderTranslatedSlots("added tag {tag} to attribute {attribute} on entity {entity}", {
        tag: <TagNameOf tagId={event.payload.tagId as string}/>,
        attribute: <EntityAttributeNameOf
          entityId={event.payload.entityId as string}
          attributeId={event.payload.attributeId as string}
  ...
  "entity_attribute_tag_deleted": {
    label: (event: ModelChangeEventDto) =>
      renderTranslatedSlots("removed tag {tag} from attribute {attribute} on entity {entity}", {
        tag: <TagNameOf tagId={event.payload.tagId as string}/>,
        attribute: <EntityAttributeNameOf
          entityId={event.payload.entityId as string}
          attributeId={event.payload.attributeId as string}
  ...
  "relationship_created": {
    label: (event: ModelChangeEventDto) =>
      renderTranslatedSlots("created relationship {relationship}", {
        relationship: <SlotTextValue value={event.payload.name ?? event.payload.key}/>
      }),
    payload: (event: ModelChangeEventDto) =>
      renderTranslatedSlots("created with {roleCount} role(s)", {
        roleCount: <SlotBadgeValue value={Array.isArray(event.payload.roles) ? event.payload.roles.length : 0}/>
      })
  },
  "relationship_key_updated": {
    label: (event: ModelChangeEventDto) =>
      renderTranslatedSlots("changed key of relationship {relationship} to {key}", {
        relationship: <RelationshipNameOf relationshipId={event.payload.relationshipId as string}/>,
        key: <SlotTextValue value={event.payload.key}/>
      }),
    payload: (event: ModelChangeEventDto) => null
  },
  "relationship_name_updated": {
    label: (event: ModelChangeEventDto) =>
      renderTranslatedSlots("changed name of relationship {relationship} to {name}", {
        relationship: <RelationshipNameOf relationshipId={event.payload.relationshipId as string}/>,
        name: <SlotTextValue value={event.payload.name}/>
      }),
    payload: (event: ModelChangeEventDto) => null
  ...
  "relationship_description_updated": {
    label: (event: ModelChangeEventDto) =>
      renderTranslatedSlots("changed description of relationship {relationship}", {
        relationship: <RelationshipNameOf relationshipId={event.payload.relationshipId as string}/>
      }),
    payload: (event: ModelChangeEventDto) => <Markdown value={(event.payload.description as string) ?? ""}/>
  },
  "relationship_role_created": {
    label: (event: ModelChangeEventDto) =>
      renderTranslatedSlots("created role {role} on relationship {relationship}", {
        role: <SlotTextValue value={event.payload.name ?? event.payload.key}/>,
        relationship: <RelationshipNameOf relationshipId={event.payload.relationshipId as string}/>
      }),
    payload: (event: ModelChangeEventDto) =>
      renderTranslatedSlots("entity {entity}, cardinality {cardinality}", {
        entity: <EntityNameOf entityId={event.payload.entityId as string}/>,
        cardinality: <CardinalityValue cardinality={event.payload.cardinality}/>
      })
  },
  "relationship_role_key_updated": {
    label: (event: ModelChangeEventDto) =>
      renderTranslatedSlots("changed key of role {role} on relationship {relationship} to {key}", {
        role: <RelationshipRoleNameOf
  ...
  "relationship_role_name_updated": {
    label: (event: ModelChangeEventDto) =>
      renderTranslatedSlots("changed name of role {role} on relationship {relationship} to {name}", {
        role: <RelationshipRoleNameOf
          relationshipId={event.payload.relationshipId as string}
          relationshipRoleId={event.payload.relationshipRoleId as string}
        />,
  ...
  "relationship_role_entity_updated": {
    label: (event: ModelChangeEventDto) =>
      renderTranslatedSlots("changed entity of role {role} on relationship {relationship} to {entity}", {
        role: <RelationshipRoleNameOf
          relationshipId={event.payload.relationshipId as string}
          relationshipRoleId={event.payload.relationshipRoleId as string}
        />,
  ...
  "relationship_role_cardinality_updated": {
    label: (event: ModelChangeEventDto) =>
      renderTranslatedSlots("changed cardinality of role {role} on relationship {relationship} to {cardinality}", {
        role: <RelationshipRoleNameOf
          relationshipId={event.payload.relationshipId as string}
          relationshipRoleId={event.payload.relationshipRoleId as string}
        />,
  ...
  "relationship_tag_deleted": {
    label: (event: ModelChangeEventDto) =>
      renderTranslatedSlots("removed tag {tag} from relationship {relationship}", {
        tag: <TagNameOf tagId={event.payload.tagId as string}/>,
        relationship: <RelationshipNameOf relationshipId={event.payload.relationshipId as string}/>
      }),
    payload: (event: ModelChangeEventDto) => null
  ...
  "relationship_role_deleted": {
    label: (event: ModelChangeEventDto) =>
      renderTranslatedSlots("deleted role {role} from relationship {relationship}", {
        role: <RelationshipRoleNameOf
          relationshipId={event.payload.relationshipId as string}
          relationshipRoleId={event.payload.relationshipRoleId as string}
        />,
  ...
  "relationship_attribute_created": {
    label: (event: ModelChangeEventDto) =>
      renderTranslatedSlots("created attribute {attribute} on relationship {relationship}", {
        attribute: <SlotTextValue value={event.payload.name ?? event.payload.key}/>,
        relationship: <RelationshipNameOf relationshipId={event.payload.relationshipId as string}/>
      }),
    payload: (event: ModelChangeEventDto) =>
  ...
  "relationship_attribute_name_updated": {
    label: (event: ModelChangeEventDto) =>
      renderTranslatedSlots("changed name of attribute {attribute} on relationship {relationship} to {name}", {
        attribute: <RelationshipAttributeNameOf
          relationshipId={event.payload.relationshipId as string}
          attributeId={event.payload.attributeId as string}
        />,
        relationship: <RelationshipNameOf relationshipId={event.payload.relationshipId as string}/>,
  ...
  "relationship_attribute_description_updated": {
    label: (event: ModelChangeEventDto) =>
      renderTranslatedSlots("changed description of attribute {attribute} on relationship {relationship}", {
        attribute: <RelationshipAttributeNameOf
          relationshipId={event.payload.relationshipId as string}
          attributeId={event.payload.attributeId as string}
        />,
  ...
  "relationship_attribute_key_updated": {
    label: (event: ModelChangeEventDto) =>
      renderTranslatedSlots("changed key of attribute {attribute} on relationship {relationship} to {key}", {
        attribute: <RelationshipAttributeNameOf
          relationshipId={event.payload.relationshipId as string}
          attributeId={event.payload.attributeId as string}
        />,
  ...
  "relationship_attribute_type_updated": {
    label: (event: ModelChangeEventDto) =>
      renderTranslatedSlots("changed type of attribute {attribute} on relationship {relationship} to {type}", {
        attribute: <RelationshipAttributeNameOf
          relationshipId={event.payload.relationshipId as string}
          attributeId={event.payload.attributeId as string}
        />,
  ...
  "relationship_attribute_optional_updated": {
    label: (event: ModelChangeEventDto) =>
      renderTranslatedSlots("changed mode of attribute {attribute} on relationship {relationship} to {optional}", {
        attribute: <RelationshipAttributeNameOf
          relationshipId={event.payload.relationshipId as string}
          attributeId={event.payload.attributeId as string}
        />,
  ...
  "relationship_attribute_tag_added": {
    label: (event: ModelChangeEventDto) =>
      renderTranslatedSlots("added tag {tag} to attribute {attribute} on relationship {relationship}", {
        tag: <TagNameOf tagId={event.payload.tagId as string}/>,
        attribute: <RelationshipAttributeNameOf
          relationshipId={event.payload.relationshipId as string}
          attributeId={event.payload.attributeId as string}
  ...
  "relationship_attribute_tag_deleted": {
    label: (event: ModelChangeEventDto) =>
      renderTranslatedSlots("removed tag {tag} from attribute {attribute} on relationship {relationship}", {
        tag: <TagNameOf tagId={event.payload.tagId as string}/>,
        attribute: <RelationshipAttributeNameOf
          relationshipId={event.payload.relationshipId as string}
          attributeId={event.payload.attributeId as string}
  ...
  "relationship_attribute_deleted": {
    label: (event: ModelChangeEventDto) =>
      renderTranslatedSlots("deleted attribute {attribute} from relationship {relationship}", {
        attribute: <RelationshipAttributeNameOf
          relationshipId={event.payload.relationshipId as string}
          attributeId={event.payload.attributeId as string}
        />,
