...
In environments where startup logs are not accessible (for example when running in containers or managed platforms), you should explicitly set this value. Minimum length is 20 characters."""
    ...
    JwtDefaultIssuer(
        key = "medatarun.auth.jwt.default.issuer",
        type = "String",
        defaultValue = "",
        description = "Default issuer used for JWTs generated by Medatarun. If not configured, Medatarun uses `urn:medatarun:internal`."
    ),
    JwtDefaultAudience(
        key = "medatarun.auth.jwt.default.audience",
        type = "String",
        defaultValue = "medatarun",
        description = "Default audience used for JWTs generated by Medatarun."
    ),
    JwtDefaultTtlSeconds(
        key = "medatarun.auth.jwt.default.ttl.seconds",
        type = "Integer",
        defaultValue = "3600",
        description = "Default lifetime in seconds for JWTs generated by Medatarun."
    ),
    ...
    OAuthClientRegistrationRetentionDays(
        key = "medatarun.auth.oauth.client.registration.retention.days",
        type = "Integer",
        defaultValue = "7",
    ...
    OAuthRefreshTokenTtlSeconds(
        key = "medatarun.auth.oauth.refresh.token.ttl.seconds",
        type = "Integer",
        defaultValue = "2592000",
        description = "Default lifetime in seconds for OAuth refresh tokens generated by Medatarun."
    );
