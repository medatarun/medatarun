...
class ModelEntityAttributeUnknownException(entityId: ModelEntityId, attributeId: ModelAttributeId) : MedatarunException("Unknown attribute $attributeId for entity $entityId")
