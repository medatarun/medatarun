...
```bash
medatarun models import --from="http://my.schemas/schema.json"
```
...
medatarun config inspect_json
medatarun models import --from="http://my.schemas/schema.json"
medatarun models import --from="datasource:myapp"
medatarun models inspect_json --modelKey=mymodel
medatarun models model_add_tag --modelKey=mymodel --tag="my tag"
```
