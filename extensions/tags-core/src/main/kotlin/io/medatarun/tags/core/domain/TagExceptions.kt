...
class TagLocalDuplicateKeyException : MedatarunException("Local tag with same key already exists", StatusCode.BAD_REQUEST)
class TagLocalNotFoundException(ref:String): MedatarunException("Local tag [${ref}] was not found", StatusCode.NOT_FOUND)
...
class TagLocalCommandIncompatibleTagRefException(ref:String): MedatarunException("Tag ref [$ref] does not point to a local tag", StatusCode.BAD_REQUEST)
class TagLocalCommandIncompatibleTagScopeRefException(ref:String): MedatarunException("Tag scope ref [$ref] can not be used for a local tag", StatusCode.BAD_REQUEST)
class TagGlobalCommandIncompatibleTagRefException(ref:String): MedatarunException("Tag ref [$ref] does not point to a global tag", StatusCode.BAD_REQUEST)
...
class TagGlobalDuplicateKeyException : MedatarunException("Global tag with same key in same group already exists", StatusCode.BAD_REQUEST)
class TagGlobalNotFoundException(tagRef: String): MedatarunException("Global tag [$tagRef] was not found", StatusCode.NOT_FOUND)
