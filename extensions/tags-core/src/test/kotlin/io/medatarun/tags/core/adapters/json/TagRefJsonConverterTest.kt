...
class TagRefJsonConverterTest {
    ...
    @Test
    fun `deserialize should accept id local key and global key formats`() {
        ...
        val localKeyRef = converter.deserialize(JsonPrimitive("key:vehicle/$localScopeId/Release_2026"))
        assertEquals(
            TagRef.ByKey(
        ...
        val globalKeyRef = converter.deserialize(JsonPrimitive("key:global/Project_A/Release-2026"))
        assertEquals(
